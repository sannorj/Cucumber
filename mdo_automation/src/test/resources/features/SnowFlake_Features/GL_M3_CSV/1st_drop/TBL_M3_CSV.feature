...
Feature: Compare M3 CSV data with TBL_M3_CSV table
   ...
   Scenario: Read first Raw data in M3 CSV file and compare data with TBL_M3_CSV table
   ...
   Scenario: Read all avalable M3 CSV file data and compare data with TBL_M3_CSV table
     Given  the application establishes the Snowflake connection to the database
     And read the  all M3 CSV file is available at given path 'src/test/resources/SnowFlake_RawData/T00 - GL Post Date Added 2023_02_01_081301.csv'
     And read the all data from  TBL_M3_CSV table in the database where file name equals to '%T00 - GL Post Date Added 2023_02_01_081301.csv%'
