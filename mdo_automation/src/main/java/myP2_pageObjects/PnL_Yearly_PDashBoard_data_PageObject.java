...
public class PnL_Yearly_PDashBoard_data_PageObject {
	...
	List<String> PnL_Yearly_elements, PDashBoard_elements, PnL_Revenue_elements, PDashBoard_Revenue_elements,
			PnL_Expenses_elements, PDashBoard_Expenses_elements;
	boolean flag;
	...
	public boolean verifyStaticKPIFunc() throws InterruptedException {
		...
		if (PDashBoard_elements.equals("N/A")) {
