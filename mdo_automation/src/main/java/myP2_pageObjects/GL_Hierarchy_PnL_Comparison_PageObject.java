...
public class GL_Hierarchy_PnL_Comparison_PageObject {

	String capturedModal;
	private WebDriver driver;
	private ConstantsReader configReader = new ConstantsReader();

	public GL_Hierarchy_PnL_Comparison_PageObject(WebDriver driver) {
		this.driver = driver;
...
//===============================================Top Child Scenario =========================================================================================	
	...
	public boolean validateTurnedOffParentModalinPnLComparison() {
